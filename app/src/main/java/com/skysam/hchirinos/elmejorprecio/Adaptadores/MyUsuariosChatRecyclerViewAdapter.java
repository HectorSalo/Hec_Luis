...
import com.skysam.hchirinos.elmejorprecio.ui.FragmentChat.UsuariosChatFragment.OnListFragmentInteractionListener;
import com.skysam.hchirinos.elmejorprecio.ui.FragmentChat.dummy.DummyContent.DummyItem;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (listUsuarios.get(position).getImagen() != null) {
            if (!listUsuarios.get(position).getImagen().isEmpty()){
                ...
                holder.imagenUsuario.setImageResource(R.mipmap.ic_usuario_sin_imagen);
            }
        } else {
            holder.imagenUsuario.setImageResource(R.mipmap.ic_usuario_sin_imagen);
        }
