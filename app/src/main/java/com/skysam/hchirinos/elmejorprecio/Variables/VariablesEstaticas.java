package com.skysam.hchirinos.elmejorprecio.Variables;

public class VariablesEstaticas {
    public static final String BD_VENDEDORES = "UsuariosVentas";
    ...
    public static final String BD_USUARIOS = "Usuarios";
